<html>
	...
	<body>
		<table align = center id = cr> 
			...
			<?php
					$rez=mysql_query("SELECT *FROM motorcycles WHERE model = 'HP4 RACE'");
					while($HP4=mysql_fetch_array($rez)){
					
						echo "<tr>
							<td><img src = 'HP4.jpg' width=100%></td>
						</tr>";
						echo"<tr>
							...
							<tr>
								<td>Марка</td>";
						printf("<td>%s</td>", $HP4['stamp']);
						echo "</tr>
							<tr>
								<td>Модель</td>";
						printf("<td>%s</td>", $HP4['model']);
						echo "</tr>
							<tr>
								<td>Год выпуска</td>";
						printf("<td>%s</td>", $HP4['year']);
						echo "</tr>
							<tr>
								<td>Объём двигателя</td>";
						printf("<td>%s см<sup>3</sup></td>", $HP4['engine_capacity']);
						echo "</tr>
							<tr>
								<td>Мощность двигателя</td>";
						printf("<td>%s л.с.</td>", $HP4['power']);
						echo "</tr>
							<tr>
								<td>Цена (в рублях)</td>";
						printf("<td>%s</td>", $HP4['price']);
						echo "</tr>
						</table>
