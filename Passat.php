<html>
	...
	<body>
		<table align = center id = cr> 
			...
			<?php
					$rez=mysql_query("SELECT *FROM cars WHERE model = 'Passat'");
					while($Passat=mysql_fetch_array($rez)){
					
						echo "<tr>
							<td><img src = 'Passat.jpg' width=100%></td>
						</tr>";
						echo"<tr>
							...
							<tr>
								<td>Марка</td>";
						printf("<td>%s</td>", $Passat['stamp']);
						echo "</tr>
							<tr>
								<td>Модель</td>";
						printf("<td>%s</td>", $Passat['model']);
						echo "</tr>
							<tr>
								<td>Год выпуска</td>";
						printf("<td>%s</td>", $Passat['year']);
						echo "</tr>
							<tr>
								<td>Объём двигателя</td>";
						printf("<td>%s л</td>", $Passat['engine_capacity']);
						echo "</tr>
							<tr>
								<td>Мощность двигателя</td>";
						printf("<td>%s л.с.</td>", $Passat['power']);
						echo "</tr>
							<tr>
								<td>Цена (в рублях)</td>";
						printf("<td>%s</td>", $Passat['price']);
						echo "</tr>
						</table>
